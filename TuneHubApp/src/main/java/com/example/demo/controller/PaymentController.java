...
public class PaymentController
{
	...
	public String createOrder()
	{
		...
		try
		{
			RazorpayClient razorpay = new RazorpayClient("rzp_test_ZvFJKhG9KP8JkV", "hI7H74V2d14NAkbTsQuFskdm");
	...
	public boolean verifyPayment(@RequestParam  String orderId, @RequestParam String paymentId,
	    ...
	    try {
	        ...
	        RazorpayClient razorpayClient = new RazorpayClient("rzp_test_ZvFJKhG9KP8JkV", 
	        								"hI7H74V2d14NAkbTsQuFskdm");
